CREATE TABLE [schemat236237].[CustomerAddress] (
    ...
    CONSTRAINT [FK_CustomerAddress_Customer_CustomerID] FOREIGN KEY ([CustomerID]) REFERENCES [schemat236237].[Customer] ([CustomerID]),
